...
export default {
  [LOCALES.ENGLISH]: {
    "app-name": "Municipal key figures",
    "app-general-error": "Something went wrong",
    "regional-time-period": "Regional zone",
    "regional-time-period-helper": "Select regional zone",
